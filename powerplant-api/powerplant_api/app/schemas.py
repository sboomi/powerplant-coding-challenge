...
class Fuels(BaseModel):
    ...
    kerosine: float = Field(..., example=50.8, title="Price of kerosine (euro/MWh)", alias="kerosine(euro/MWh)")
    co2: float = Field(..., example=20, title="Price of emission allowances (euro/ton)", alias="co2(euro/ton)")
